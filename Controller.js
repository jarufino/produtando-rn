...
app.post('/verifyPass',async (req,res)=>{
    ...
    if(response===null){
        ...
        if(req.body.novaSenha===req.body.confNovaSenha){
            ...
            response.save();
            res.send(JSON.stringify('Alterei a sua senha com sucesso'));    
        }else {
            res.send(JSON.stringify('Nova senha e a confirmação dela não conferem'));
        }
    }
});
//Cadastro produto no BD
